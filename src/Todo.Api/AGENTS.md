...
| `POST` | `/api/todo-lists/{todoListId:guid}/items/{todoItemId:guid}/manifest` | `RequestManifestationEndpoint` (`Endpoints/Manifestations/`) |
...
`/api/manifestations`, OpenAPI tag `Manifestations`.
